...
for path in png_files:
    ...
    # Output to header
    header_file.write(b"extern unsigned char " + m.group(1).encode() + b"_png[" + str(count).encode() + b"];\n")
    # Create the C file
    ...
    source_file.write(text.encode())

header_file.write(b"#endif //__PNG_HEADER_FILE_H__\n")
